...
class SecurityManager {
    ...
    async loadSocialAccounts() {
        try {
            const response = await this.dashboard.apiManager.makeRequest('/social-accounts');
            ...
            this.dashboard.toastManager.showToast('error', 'Error', 'Failed to load social accounts');
        }
    }
